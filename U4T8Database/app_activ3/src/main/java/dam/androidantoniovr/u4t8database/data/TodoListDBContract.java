...
public final class TodoListDBContract {
    ...
    public static class Tasks {
        ...
        //TODO - agregamos el nombre de las columnas priority y status
        ...
        public static final String CREATE_TABLE = "CREATE TABLE " + TodoListDBContract.Tasks.TABLE_NAME
                ...
                //TODO - agregamos los campos priority y status al SQL String
                + TodoListDBContract.Tasks.PRIORITY + " TEXT, "
                + TodoListDBContract.Tasks.STATUS + " TEXT"
                + ");";

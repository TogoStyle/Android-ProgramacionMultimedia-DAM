...
public class MainActivity extends AppCompatActivity {
    ...
    private void setUI(){
        ...
        idEncrypt = findViewById(R.id.idEncrypt);
    ...
    public void goToSharedPreferencesActivity(View view) {
        ...
        //TODO - ENCRIPTAR EL ARCHIVO DE MYPREFS
        //COMPROBAMOS SI EL USUARIO SELECCIONA LA OPCION DE ENCRIPTAR
        if (idEncrypt.isChecked()){
            String masterKeyAlias = null;
            try {
                //SI ESTÁ SELECCIONADO OBTENEMOS O CREAMOS NUESTRA MASTERKEY DE ENCRIPTACION
            ...
            //CREAMOS EL ARCHIVO DE MYPREFS ENCRIPTADO CON EL CONTEXTO DE LA MAINACTIVITY
            ...
            //Y COMO HEMOS HEHCO ANTERIORMENTE VOLVEMOS A ESCRIBIR EN EL EDITOR DE LAS SHAREDPREFERENCES NUESTROS VALORES

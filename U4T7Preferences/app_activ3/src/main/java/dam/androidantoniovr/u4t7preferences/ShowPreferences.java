...
public class ShowPreferences extends AppCompatActivity {
    ...
    private void setUI(){
        ...
        if (radioButtonSelected == R.id.radioButtonSharedPreferences){
        ...
        }else if (radioButtonSelected == R.id.radioButtonPreferences){
        ...
        } else if (radioButtonSelected == R.id.radioButtonDefaultSharedPreferences){
